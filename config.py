...
def get_enhanced_default_config() -> Config:
    return Config()


def get_enhanced_fast_config() -> Config:
    config = Config()
...
def get_enhanced_thorough_config() -> Config:
    config = Config()
...
def get_enhanced_precision_config() -> Config:
    config = Config()
...
def get_enhanced_recall_config() -> Config:
    config = Config()
